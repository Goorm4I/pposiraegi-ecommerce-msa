package cloud.pposiraegi.user.global;

import cloud.pposiraegi.common.model.PhoneNumber;
import cloud.pposiraegi.product.domain.user.entity.User;
import cloud.pposiraegi.product.domain.user.repository.UserRepository;
